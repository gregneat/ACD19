...
public class Car implements Vehicle{
	...
	{
		Rectangle2D.Double[] r = new Rectangle2D.Double[1];
		
		r[0] = new Rectangle2D.Double(body1.getX(),body2.getY(),body1.getWidth(),
		body1.getHeight()+body2.getHeight()+wheel1.getHeight());
