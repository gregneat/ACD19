...
public class Truck implements Vehicle
{
	...
	public void drive()
	{
		...
		locLabel = body.getX()+getSpeed()+", "+getY();
	}
	...
	public void paint(Graphics g)
	{
		...
		g.drawString(locLabel,(int)body.getX()+35,(int)getY()+45);
		g.drawString(label,(int)body.getX()+35,(int)getY()+25);
	}
